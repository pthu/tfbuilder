...
langsettings = {
    ...
    'greek': {
        ...
        'ignore_attrib_keys': {'corresp', 'merge', 'resp', 'id', 'xml:id',},
        'non_section_keys': {'altpage', 'altpage1', 'altnumbering', 'altref', 'mspage', 'xml:lang', 'corresp', 'xml:id', 'ed', 'id',},
        'non_section_values': {'altpage', 'altpage1', 'altnumbering', 'altref', 'mspage', 'xml:lang', 'edition', 'mignepage', 'stephnumbering', 'vignumbering', 'altnumbering', 'ms', 'textpart', 'altedition', 'page', 'line', 'Line', 'bekker page', 'tlnum', 'stephpage',},

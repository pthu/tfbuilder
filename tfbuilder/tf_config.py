...
langsettings = {
    'generic': {
        ...
        'tokenizer_args': {'punc': True, 
                           ...
                           'splitters': None,
                           'non_splitters': ('-', '<'),},
        'token_out': OrderedDict(['pre': {'text_format': False, 'metadata': 'interpunction before word'},
                      'word': {'text_format': True, 'metadata': 'the word without interpunction'},
                      'post': {'text_format': False, 'metadata': 'interpunction after word'},
                     ]),
        'lemmatizer': None,
    ...
    'greek': {
        ...
        'token_out': OrderedDict(['pre': {'text': False, 'metadata': 'interpunction before word'},
                      'word': {'text': True, 'metadata': 'the word without interpunction'},
